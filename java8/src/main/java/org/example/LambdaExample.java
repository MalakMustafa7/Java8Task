    ...
    public static void main(final String[] args) {
       ...
       repository.select(user -> user.active, null);
        ...
        // TODO With functional interfaces declared
         ...
         repository.select(userAgePredicate,userNameComparator);
       ...
       repository.select(user->user.age>5, Comparator.comparing(user -> user.name));
        ...
        // TODO With functional interfaces declared
        Predicate<User> userAgerPredicate2 = new Predicate<User>() {
            @Override
            public boolean test(User user) {
                return  user.age<10;
            }
        ...
        repository.select(userAgerPredicate2,userAgeComparator);
        ...
        // TODO With functional interfaces declared
        Predicate<User> userActivePredicate = new Predicate<User>() {
            @Override
            public boolean test(User user) {
                return  user.active;
            }
        };
        repository.select(userActivePredicate,userNameComparator);
        ...
        // TODO With functional interfaces declared
        Predicate<User> userAgerPredicate3 = new Predicate<User>() {
            @Override
            public boolean test(User user) {
                return  user.active && user.age>8;
            }
        };
        repository.select(userAgerPredicate3,userNameComparator);
